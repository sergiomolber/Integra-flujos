...
@RunWith(Incluirarchivos.class)
@Suite.SuiteClasses({})
public class Incluirarchivos extends Suite {

    public Incluirarchivos(Class<?> klass, RunnerBuilder builder) throws InitializationError {
        super(klass, builder);
    }
    ...
    @CucumberOptions(
            ...
            tags = {"@SubirArchivoExitosoJPmorgan,@SubirArchivoExitosoDavivienda,@SubirArchivoExitosoDaviviendaPSE"},
            glue = "com.integra.ach.stepDefinitions",
            snippets = SnippetType.CAMELCASE
    )
    public static class CargarArchivoExitosoRunner {
        @BeforeSuite
