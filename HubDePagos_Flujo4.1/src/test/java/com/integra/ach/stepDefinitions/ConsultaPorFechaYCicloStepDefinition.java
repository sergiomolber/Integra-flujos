...
public class ConsultaPorFechaYCicloStepDefinition {
    ...
    public void ingresarACuadreYConciliacionYDiligenciarFormularioDeConsulta(String ciclo) {
    ...
    public void ingresarAPlanillaConsolidadaYDiligenciarFormularioDeConsulta( String ciclo) {
        integraMenuPrincipalStep.clickReportesDeCompensacion();
        integraMenuPrincipalStep.clickPlanillaConsolidada();
        integraPlanillaConsolidadaStep.escribirFecha();
    ...
    public void ingresarAPlanillaDeCompensacionYDiligenciarFormularioDeConsulta( String ciclo, String entidad) throws AWTException {
        integraMenuPrincipalStep.clickReportesDeCompensacion();
        integraMenuPrincipalStep.clickPlanillaDeCompensacion();
        integraPlanillaDeCompensacionStep.escribirFecha();
