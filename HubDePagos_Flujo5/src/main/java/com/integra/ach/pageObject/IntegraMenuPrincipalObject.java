...
public class IntegraMenuPrincipalObject extends PageObject {
    ...
    By btnLimites = By.xpath("//*[@id=\"Limits\"]");
    ...
    By BtnReporteMinimoXEf = By.xpath("//*[@id=\"MinimumAmountFEReport\"]/a");
    ...
    public By getBtnReporteMinimoXEf() {
        return BtnReporteMinimoXEf;
    }
