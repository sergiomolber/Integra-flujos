...
public class IntegraEditarEntidadStep {
    ...
    @Step
    public void ingresoFechaDesde(String FechaDesde){
        Utilidades.esperar(2000);
    ...
    public void validolblEliminaciónExitosa(){
        Utilidades.esperarExplicito30(integraEditarEntidadObject.getDriver(), integraEditarEntidadObject.getLblValidarElimicionExitosa());
