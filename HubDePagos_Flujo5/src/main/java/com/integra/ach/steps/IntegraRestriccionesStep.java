...
//        robot.hacerTap1();
    ...
    @Step
    public void clickDescargarInstruccionDistribuida() {
        integraRestriccionesObject.getDriver().findElement(integraRestriccionesObject.getbtnDescargarInstruccionDistribuida()).click();
        EsperaImplicita.esperaImplicitaWeb(5);
    }
}
