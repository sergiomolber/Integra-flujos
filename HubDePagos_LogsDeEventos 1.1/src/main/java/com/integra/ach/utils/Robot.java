...
public class Robot {
    ...
    public static String fechahora1() {
        ...
        LocalDateTime fechaSistema = LocalDateTime.now();
        // Definir formato fecha y hora
        DateTimeFormatter fechaHoraFormatter = DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss");
        // Dar formato a la fecha y hora del sistema
        String formatFechaHora1 = fechaSistema.format(fechaHoraFormatter);
        return formatFechaHora1;
    }
