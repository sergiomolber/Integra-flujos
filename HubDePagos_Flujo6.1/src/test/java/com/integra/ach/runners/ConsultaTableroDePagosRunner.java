...
@RunWith(ConsultaTableroDePagosRunner.class)
@Suite.SuiteClasses({})
public class ConsultaTableroDePagosRunner extends Suite {

  public ConsultaTableroDePagosRunner(Class<?> klass, RunnerBuilder builder) throws InitializationError {
       super(klass, builder);
    }
