...
@CucumberOptions(
        ...
        tags = {"@GenerarReporteEstadisticoAcumulado,@GenerarReporteEstadisticoArchivoDeSalida,@GenerarReporteEstadisticoDescripcionLote,@GenerarReporteEstadisticoDiario"},
        glue = "com.integra.ach.stepDefinitions",
        snippets = SnippetType.CAMELCASE
)
public class ReporteEstadisticoRunner {
    @BeforeSuite
